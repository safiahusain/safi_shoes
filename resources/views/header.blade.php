    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{url('dashboard')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        {{-- <img src="{{asset('assets/images/banu1.png')}}" alt="" height="22"> --}}
                        <img src="{{asset('assets/images/property_logo1.png')}}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        {{-- <img src="{{asset('assets/images/banu1.png')}}" alt="" height="17"> --}}
                        <img src="{{asset('assets/images/property_logo1.png')}}" alt="" height="17">
                    </span>
                </a>

                <a href="{{url('dashboard')}}"  class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{asset('assets/images/property_logo1.png')}}" alt="" height="30">
                        {{-- <img src="{{asset('assets/images/banu3.png')}}" alt="" height="30"> --}}
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset('assets/images/property_logo1.png')}}" alt="" height="50">
                        {{-- <img src="{{asset('assets/images/banu3.png')}}" alt="" height="30"> --}}
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- sitem-->
                    <a class="dropdown-item" href="{{route('show-profile') }}"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">Profile</span></a>
