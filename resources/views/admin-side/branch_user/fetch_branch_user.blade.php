                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100 table-sm">
                                        ...
                                        <tr>
                                            ...
                                            <!--<td>{{$item->status}}</td>-->
                                            <td>
                                                <a href="{{ url('edit-branchs/'.$item->id)}} " class="btn btn-primary btn-sm">Edit</a>
                                                |
                                                <a href="{{ url('delete-branchs/'.$item->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to Delete this Record ?')">Delete</a>
                                            </td>
            ...
            <div class="modal-body">
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-nowrap">
                        ...
                        <tbody>
                            <form class="needs-validation"  novalidate action="{{ url('store-branchs')}}"  method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
