...
<body>
  ...
  <div class="ch-container">
    ...
    <div id="content" class="col-lg-10 col-sm-10">
        <form action="{{ route('upadte-purchaseInvoice',['id' => $data->id,'param'  => $param]) }}" method="post" enctype="multipart/form-data" id="purchase_form">
            @csrf
            <div class="row">
                <div class="box col-md-10">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="" style="background-color : rgba(10,10,40,0.7) !important; color:white;">
                                ...
                                <h2>
                                    <i class="glyphicon glyphicon-user"></i> Edit Return Stock
                                </h2>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" hidden=""value="{{$data->user->id}}" name="warehouse_id"/>
                                        <input type="text" readonly value="{{$data->user->email}}" readonly name="warehouse" class="form-control warehouse_name"/>
                                        <!--<select name="warehouse_id" class="form-control combine js-example-basic-single" tabIndex="-1" required>-->
                                        <!--    <option value="" readonly>Select Warehouse </option>-->
                                        <!--    @foreach ($users as $key  => $user)-->
                                        <!--        <option value="{{$user->id}}" @if($data->user_id == $user->id) selected @endif>{{$user->email}}</option>-->
                                        <!--    @endforeach-->
                                        <!--</select>-->
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6"> 
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" readonly value="{{$data->color->name}}" name="color" class="form-control warehouse_name"/>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" readonly value="{{$data->product->name}}" name="product_name" class="form-control warehouse_name"/>
                                            <!--<div id='show_product'>-->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" readonly value="{{$data->size}}" name="size_id" class="form-control warehouse_name"/>
