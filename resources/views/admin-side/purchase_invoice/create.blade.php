...
<body>
  ...
  <div class="ch-container">
    ...
    <div id="content" class="col-lg-10 col-sm-10">
        <form  action="{{route('store-purchaseInvoice',['param'  => $param])}}" method="post" enctype="multipart/form-data" id="purchase_form">
            @csrf
            <div class="row">
    ...
    <script>
            ...
            input_value +=  "<select name='product_id' class='form-control combine js-example-basic-single' onchange='productName(this)' tabIndex='-1' required>\
                                ...
                                $.each(product_data, function (key, value)
                                {
                                    if(key  ==  'name_'+i)
                                    {
                                        ...
                                        input_value +=  "<option value='"+pro_id+"'>"+capitalizeFirstLetter(value)+"</option>";
                                        i++;
                                    }
                                });
            input_value +=  "</select>";
        ...
        function calc(findIndex)
        {
            ...
            if(quantity>stock)
            {
                ...
                $(".validation_error").text("Quantity must be less than stock");
