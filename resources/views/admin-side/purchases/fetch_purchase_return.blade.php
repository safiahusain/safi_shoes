                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!--</p>-->
                                     ...
                                     <a href="{{url('purchase-invoice-return-form')}}">  <button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light" >
                                            Add New Record
                                        </button> </a> <br><br>
                                    </div> 
                                    ...
                                    <table id="table_one" class="table table-bordered table-responsive nowrap">
                                        ...
                                        <tr>
                                          ...
                                          <!-- <td>
                                                <a href="{{url('edit-purchase-return-invoice/'.$item->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                                |
                                                <a href="{{ url('delete-purchase-return-invoice/'.$item->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to Delete this Record ?')">Delete</a>
                                                ...
                                                <button
                                                    ...
                                                    >
                                                 <a href="{{url('customer-purchase-return-detail/'.$item->id)}}">   <i class="fa-solid fa-magnifying-glass-plus"></i></a>
                                                    </button>
                                            ...
                                            <a href="{{url('edit-purchase-return-invoice/'.$item->id)}}"  style="background-color:white; border:none">
                                           <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                            |
                                            <a href="{{ url('delete-purchase-return-invoice/'.$item->id) }}"   onclick="return confirm('Are you sure to Delete this Record ?')">   <button style="background-color:white; border:none" name="product_id[]" value="{{$item->product_id}}" >
    ...
    <script>
       ...
       function getPrint2(exampleModal)
       {
            ...
            $.ajax({
                  ...
                  type:"GET",
                  url:"fetch-purchase-return-invoice-detail-ajax/"+purchase_detail,
                  datatype:"JSON",
                  success:function(response)
                  {
                    ...
                    $.each(response.purchase_return_detail, function(key, item){
                    ...
                    var i = 1;
                    $('#p_t_body').html('');
                    $.each(response.purchaseii_return_detail, function(key, item){
        ...
        $(document).on('click', '#purchase_detail', function(e){
            ...
            $.ajax({
              ...
              success:function(response)
              {
                ...
                // console.log(response.purchase_return_detail)
