  ...
  <div class="ch-container">
    <div class="row">
      ...
      <div id="content" class="col-lg-10 col-sm-10">
        ...
        <form  action="{{url('update-purchase-return-invoice/'.$purchaseinvoicei->id)}}" method="post" enctype="multipart/form-data" id="purchase_form">
         @csrf
         <!-- <span class="formdata"> -->
          <div class="row">
            <div class="box col-md-12">
              <div class="box-inner">
                <div class="box-header well col-sm-10" data-original-title="" style="background-color : rgba(10,10,40,0.7) !important; color:white;">
                  <h2><i class="glyphicon glyphicon-plus"></i>Edit Purchase Return Invoice</h2>
                </div>
                          ...
                          <tr id="TRow" class="d-none">
                            ...
                            <td>
                              {{-- <input style="
                                ...
                                <select required name="product_name[]" onchange="productName(this)" data-id="{{$purchaseinvoice->id}}" data-key="{{$key=null}}" data-product-id="{{$purchaseinvoice->product_id}}" data-invoice-id="{{$purchaseinvoice->id}}" class="form-control combine js-example-basic-single" id="product_size_no" style="width:70px" tabIndex="-1">
                            ...
                            <td style="padding-right: 3px" id="edit_stock">
                                <input class="form-control combine num_only_integer_quantity vertical stock_no" id="stock-no" value="" type="text"  name="stock[]" required readonly onkeyup="calc(this)"  style="width:70px;"/>
                                </td>
                            <input type="hidden" id='pro_id'>
                            <td style="padding-right: 3px">
                            <input class="form-control combine price num_only_integer_quantity vertical"
                                  type="text" readonly  name="price[]" value="{{$purchaseinvoice->price}}" required onkeyup="calc(this)"  style="width:70px;"/>
                            </td>
                            <td>
                            ...
                            <td style="display:none;">
                              <input type="text"  class="form-control form_discount num_only_decimal vertical" name="discount_product[]" required value="{{$purchaseinvoice->discount}}" onkeyup="calc(this)" style="width:70px;"/>
                            </td>
                            <td style="display:none;">
                              <input type="text"  readonly class="form-control less  num_only_decimal vertical" name="less[]" required value="{{$purchaseinvoice->less}}"  style="width:70px;"/>
                            </td>
                            <td>

                            <input class="form-control net num_only_decimal vertical"
                                  type="text" readonly id="net"  name="net[]" value="{{$purchaseinvoice->net}}"   style="width:90px;"/>
                            </td>
                            <td>
                        ...
                        <tfoot id="tfoot">
                          ...
                          <tr style="display:none;">
                            ...
                            <td colspan="2" class="discount-td">
                              <input readonly class="form-control discount-val num_only_decimal vertical"
                               ...
                               id="total_discount"
                                type="text" name="total_discount" value="{{$purchaseinvoicei->discount}}"  style="width:150px;"/>
                            </td>
                          </tr>
                          ...
                          <tr style="display:none;">
                            ...
                            <td colspan="2"  id="net_amount">
                              <input type="text" readonly class="form-control" value="{{$purchaseinvoicei->total_discount_value}}"  style="width:150px;" name="total_discount_value" id="total_discount_value">
                            </td>
                          </tr>
                          <tr style="display:none;">
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="discount-td">
                              ...
                              <input type="text" value="{{$purchaseinvoicei->less}}" class="form-control extra-discountss" name="extra_discount"  style="width:150px;" onkeyup="findExtraDiscount(this)">
                            </td>
                          </tr>
                          ...
                          <tr style="display:none;">
                            ...
                            <td colspan="2" class="total-val" id="sub_total">
                             <input type="text" readonly name="sub_total" class="form-control sub_totals"  value="{{$purchaseinvoicei->sub_total}}"  style="width:150px;">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                          ...
                          <tr>
                            ...
                            <td colspan="2" class="total-val" id="payable_balance">
                              <input type="text" readonly class="form-control" value="{{$purchaseinvoicei->total_value_of_sub_previous}}" name="total_value_of_sub_previous" id="total_value_of_sub_previous"  style="width:150px;">
                            </td>
                          </tr>
                          <!-- <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="discount-td">
                             <input type="text" value="{{$purchaseinvoicei->paid_customer_balance}}" class="form-control paid_customer_balance" id="paid_customer_balance" name="paid_customer_balance" onkeyup="paidCustomerBalance(this)">
                            </td>
                          </tr>  -->
                          <tr>
                            <td colspan="6"></td>
  ...
  <script>
    ...
    $(document).ready(function()
    {
        ...
        function updateStockOnSizeChange(x)
        {
            ...
            console.log(selectedValue,index2,product_id);
            $("#edit_stock").removeClass('d-none');
            ...
            $.ajax(
            {
                ...
                success :   function(response)
                {
                    ...
                    $.each(product_stock, function (key, value)
                    {
                        if('size_'+i ==  key)
                        {
                            console.log(value,selectedValue,product_stock)
