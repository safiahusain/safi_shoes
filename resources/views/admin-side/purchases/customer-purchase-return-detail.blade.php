...
<body>
    <section class="container">
        <div class="box-header" style="background-color : rgba(10,10,40,0.7) !important; color:white;">
            <h2>Purchase Retrun Invoice Detail</h2>
        </div>
        <div style="padding: 10px 20px;">
            <h3 class="text-center">Company: <span>{{$purchaseinvoicei->company_name}}</span></h3>
            <div style="display: flex; justify-content: space-between;">
                <div>
                    <p>Purchase Return Invoice #: <span>{{$purchaseinvoicei->id}}</span></p>
                ...
                <tfoot id="tfoot">
                  ...
                  <tr>
                    <td style="display: flex; gap: 10px;">
                     <a class="a-href" href="{{url('edit-purchase-return-invoice',$purchaseinvoicei->id)}}"> <button type="button" id="btn_aedit" class="btn btn-success btn-sm">Edit</button></a>
                     <a class="a-href" href="{{url('show-purchase-return-invoice')}}"><button type="button" id="btn_close" class="btn btn-success btn-sm">Close</button> </a> 
