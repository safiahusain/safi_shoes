                ...
                <div class="box-content col-sm-10" id="add_form">
                  <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <div class="controls">
                        <select id="company_id" class="js-example-basic-single"  data-rel="chosen"
                ...
                <div class="box col-md-10">
                  <div class="box-inner">
                    ...
                    <div class="box-content">
                      <table class="table table-striped table-bordered bootstrap-datatable responsive purchase-return-table" id="myTable">
                        <thead>
                          <tr>
                            <th width="50">S.No</th>
                ...
                <!-- ********************product id************************************* -->
                            ...
                            <td>
                              {{-- <input style="
                                ...
                                name="product_name[]" id="product_name" onkeyup="productName(this)"/> --}}
                                <select name="product_name[]"  onchange="productName(this)" class="form-control combine js-example-basic-single" id='product_size_no' style="width:100px;" tabIndex="-1" required>
...
<!-- select2 tag cdn  -->
  ...
  <script>
    ...
    function addbtn() 
    {
        var lastRow =   $('.purchase-return-table tbody tr:last-child');
        ...
        newRow.find("[id]").each(function() 
        {
            ...
            var newId = oldId ? oldId.replace(/\d+$/, "") + "_" + ($('.purchase-return-table tbody tr').length) : undefined;
        ...
        function productName(findindex)
        {
            ...
            $.ajax(
            {
                ...
                success :   function(response)
                {
                    ...
                    let stock_data  =   "";
                    $('.purchase-return-table tbody').find('tr:last-child .size-no-data').html('');
