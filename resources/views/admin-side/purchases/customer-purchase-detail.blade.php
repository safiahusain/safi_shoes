    ...
    <section class="container">
        ...
        <div style="padding: 10px 20px;">
            ...
            <div style="display: flex; justify-content: space-between;">
                <div>
                    <p>Purchase Invoice #: <span>{{$purchaseinvoicei->id}}</span></p>
                ...
                <tfoot id="tfoot">
                  ...
                  <tr>
                    <td style="display: flex; gap: 10px;">
                     <a class="a-href" href="{{url('edit-purchase-invoice',$purchaseinvoicei->id)}}"> <button type="button" id="btn_aedit" class="btn btn-success btn-sm">Edit</button></a>
                     <a class="a-href" href="{{url('show-purchase-invoice')}}"><button type="button" id="btn_close" class="btn btn-success btn-sm">Close</button> </a> 
