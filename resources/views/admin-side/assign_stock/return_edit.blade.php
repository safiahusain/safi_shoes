                ...
                <div class="box col-md-10">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="" style="background-color : rgba(10,10,40,0.7) !important; color:white;">
                            @if($param  ==  'return')
                                <h2>
                                    <i class="glyphicon glyphicon-user"></i>Edit Return Assign Stock
                                </h2> 
                            @else
                                <h2>
                        ...
                        <div class="box-content">
                                        <input type="text" hidden="" value="{{Auth::user()->id}}" name="warehouse_id" class="user_id" id="user_id" />
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="validationCustom01" class="form-label">user:</label>
                                            <select name="user_id"form-control combine js-example-basic-single" tabIndex="-1" required>
            ...
            input_value +=  "<select name='product_id' class='form-control combine js-example-basic-single' onchange='productName(this)' tabIndex='-1' required>\
                                ...
                                $.each(product_data, function (key, value)
                                {
                                    if(key  ==  'name_'+i)
                                    {
                                        ...
                                        input_value +=  "<option value='"+pro_id+"' " + (product_id == pro_id ? "selected" : "") + ">"+capitalizeFirstLetter(value)+" ("+pro_code+")"+"</option>";
                                        i++;
                                    }
                                });
            input_value +=  "</select>";
