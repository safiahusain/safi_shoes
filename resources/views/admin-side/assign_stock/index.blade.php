                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!--<p class="card-title-desc">Data table with CSV and -->
                                        ...
                                        @if(($param  ==  'invoice' && Auth::user()->role_id   ==  1) )
                                             <div class="align-middle " >
                                             <a href="{{url('add/warehouse/stock/'.'invoice')}}">  <button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light" >
                                                    Add New Record
                                                </button> </a> <br><br>
                                            </div> 
                                        @endif
                                    @if($param  ==  'return'    ||  $param  ==  'branch')
                                         <div class="align-middle " >
                                                @if($param  ==  'return')
                                                    <a href="{{url('warehouse/stock/'.'return')}}">  <button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light" >
                                                    Return Stock
                                                @else
                                                    <a href="{{url('warehouse/stock/'.'branch')}}">  <button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light" >
                                                    Assign Stock
                                                @endif
                                            </button> </a> <br><br>
                                        </div> 
                                    ...
                                    <table id="table_one" class="table table-bordered dt-responsive nowrap w-100 table-sm">
                                        ...
                                        <tr>
                                            ...
                                            @if(Auth::user()->role_id   ==  1)
                                                <td>
                                                    <a href="{{ url('edit/warehouse/stock/' . urlencode($param) . '/' . $item->id) }}" class=""> <i class="fa-solid fa-pen-to-square"></i></a>
                                                    |
                                                    <a href="{{ url('delete/warehouse/stock/' . urlencode($param) . '/' . $item->id)}}" class="" onclick="return confirm('Are you sure to Delete this Record ?')"><button style="background-color:white; border:none;"><i class="fa-solid fa-trash-can"></button></i></a>
                                                    <!--@if($param  ==  'invoice')-->
                                                    <!--    |-->
                                                    <!--    <a href="{{url('edit/warehouse/stock/'.'return/'.$item->id)}}" class="btn btn-primary btn-sm mx-2 text-white">Return</a>-->
                                                    <!--@endif-->
                                                </td>
                                            @endif
                                            @if($param  ==  'return'    ||  $param  ==  'branch')
                                                <td>
                                                    <a href="{{ url('return/warehouse/' . urlencode($param) . '/' . $item->id) }}" class=""> <i class="fa-solid fa-pen-to-square"></i></a>
                                                    |
                                                    <a href="{{ url('delete/warehouse/stock/' . urlencode($param) . '/' . $item->id)}}" class="" onclick="return confirm('Are you sure to Delete this Record ?')"><button style="background-color:white; border:none;"><i class="fa-solid fa-trash-can"></button></i></a>
