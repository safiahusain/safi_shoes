                                    ...
                                    <table id="datatable-buttons" class="table text-center table-bordered dt-responsive nowrap w-100 table-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                |
                                                <a href="{{ url('delete-color/'.$item->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to Delete this Record ?')">Delete</a>
                                            </td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="transaction-detailModalLabel">Color's Details</h5>
            ...
            <div class="modal-body">
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-nowrap">
                        ...
                        <tbody>
                            <form class="needs-validation"  novalidate action="{{ route('store-color')}}"  method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
