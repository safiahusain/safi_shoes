...
<body>
  ...
  <div class="ch-container">
    ...
    <div id="content" class="col-lg-10 col-sm-10">
        <!--<form  action="{url('upadte-warehouse-stock/'.$data->id)}}" method="post" enctype="multipart/form-data" id="purchase_form">-->
        <form action="{{ route('upadte-branch-stock',['id' => $data->id,'param'  => $param]) }}" method="post" enctype="multipart/form-data" id="purchase_form">
            @csrf
            <div class="row">
                <div class="box col-md-10">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="" style="background-color : rgba(10,10,40,0.7) !important; color:white;">
                            @if($param == 'invoice') 
                                <h2>
                                    <i class="glyphicon glyphicon-user"></i> Edit Assign Stock
                                </h2>
                             @else  
                                <h2>
                                    <i class="glyphicon glyphicon-user"></i> Return Assign Stock
                                </h2> 
                            @endif
                        </div>
                        <div class="box-content">
                                        ...
                                        @if($param  ==  'invoice')
                                            <select name="btanch_id" class="form-control combine js-example-basic-single" tabIndex="-1" required>
                                                ...
                                                @foreach ($users as $key  => $user)
                                                    <option value="{{$user->id}}" @if($data->branch_id == $user->id) selected @endif>{{$user->email}}</option>
                                                @endforeach
                                            </select>
                                        @else
                                            <input type="text" readonly value="{{$data->branch_id}}" name="btanch_id" class="form-control"/>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <input type='hidden' id="stock_data" value="{{json_encode($groupedStocks)}}">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <div id="edit_stock">
                                            ...
                                            @else
                                                @if($target ==  'stock')
                                                    <input class="form-control combine Stock num_only_integer_quantity vertical stock_no" type="text" readonly value="{{$result}}" name="stock" class="form-control"/>
                                                @else
                                                    <input class="form-control combine Stock num_only_integer_quantity vertical stock_no" type="text" readonly value="{{$result}}" name="stock" class="form-control"/>
                                                @endif
                                            @endif
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        @else
                                                <input type='text' hidden="" value='{{$result}}' name="prev_quantity">
                                            @if($target ==  'stock')
                                                <input class="form-control combine num_only_integer_quantity quantity vertical" type="text" id="quantity_value"  data_id="{{$data->product_id}}" data_param={{$param}} data_target="{{$target}}"  data_value="{{$result}}" name="quantity" value="{{$result}}"  onkeyup="calc(this)" required/>
                                            @else
                                                <input class="form-control combine num_only_integer_quantity quantity vertical" type="text" id="quantity_value"  data_id="{{$data->product_id}}" data_target="{{$target}}" data_value="{{$data->assign_stock}}" data_param={{$param}} name="quantity" value="{{$data->assign_stock}}"  onkeyup="calc(this)" required/>
                                            @endif
                                        @endif
