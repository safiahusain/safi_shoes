                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100 table-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$item->status}}</td>
                                            <td>
                                                <a href="{{ url('edit-manager/'.$item->id)}} " class="btn btn-primary btn-sm">Edit</a>
                                                |
                                                <a href="{{ url('delete-manager/'.$item->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to Delete this Record ?')">Delete</a>
                                            </td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="transaction-detailModalLabel">Manager's Details</h5>
            ...
            <div class="modal-body">
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-nowrap">
                        ...
                        <tbody>
                            <form class="needs-validation"  novalidate action="{{ route('store-manager')}}"  method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            placeholder="Enter Manager Email" name="email"  >
                                            @if($errors->has('email'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            placeholder="Enter Manager Address" name="address"  >
