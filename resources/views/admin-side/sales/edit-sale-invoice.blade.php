  ...
  <div class="ch-container">
    <div class="row">
      ...
      <div id="content" class="col-lg-10 col-sm-10">
        ...
        <form  action="{{url('update-sale-invoice/'.$purchaseinvoicei->id)}}" method="post" enctype="multipart/form-data" id="purchase_form">
         @csrf
         <!-- <span class="formdata"> -->
          <div class="row">
            <div class="box col-md-12">
              <div class="box-inner">
                <div class="box-header well col-sm-10" data-original-title="" style="background-color : rgba(10,10,40,0.7) !important; color:white;">
                  <h2><i class="glyphicon glyphicon-plus"></i>Edit Sale Invoice</h2>
                </div>
                        ...
                        <tbody id="TBody">
                          ...
                          <tr id="TRow" class="d-none">
                            ...
                            <td>
                              ...
                              <!--    type="text"  name="color[]" readonly value="{{$purchaseinvoice->color}}"  style="width:70px;" />-->
                            </td>
                            <td>
                            ...
                            <input class="form-control combine price num_only_integer_quantity vertical"
                                  type="text"  name="price[]" readonly value="{{$purchaseinvoice->price}}" required onkeyup="calc(this)"  style="width:70px;"/>
                            </td>
                            <td>
                            ...
                            <td>
                              <input type="text" class="form-control total total_roww" readonly name="total[]"  value="{{$purchaseinvoice->total}}" style="width:70px;">
                        ...
                        <tfoot id="tfoot">
                          <tr>
                            ...
                            <td colspan="2"  id="total_amount">
                              ...
                              <!--<input type="text" readonly hidden=""  class="form-control sum_totals_of_product" name="sum_of_all_product" value="{{$purchaseinvoicei->sum_of_all_product}}">-->
                            </td>
                          </tr>
                          ...
                          <tr style="display:none;">
                            ...
                            <td colspan="2" class="discount-td">
                              <input readonly class="form-control discount-val num_only_decimal vertical"
                                ...
                                font-size: 16px;"
                               id="total_discount"
                                type="text" name="total_discount" readonly value="{{$purchaseinvoicei->discount}}"/>
                            </td>
                          </tr>
                          ...
                          <tr style="display:none;">
                            ...
                            <td colspan="2"  id="net_amount">
                              <input type="text" class="form-control" readonly value="{{$purchaseinvoicei->total_discount_value}}" name="total_discount_value" id="total_discount_value">
                            </td>
                          </tr>
                          <tr style="">
                            <td colspan="6"></td>
                          ...
                          <tr style="display:none;">
                            ...
                            <td colspan="2" class="total-val" id="sub_total">
                             <input type="text" name="sub_total" readonly class="form-control sub_totals"  value="{{$purchaseinvoicei->sub_total}}">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="prebal-val" id="previous_bal">
                             <input type="text" value="{{$purchaseinvoicei->old_balance}}" readonly class="form-control balance" id="previous_balance">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="total-val" id="payable_balance">
                              <input type="text" class="form-control" readonly value="{{$purchaseinvoicei->total_value_of_sub_previous}}" name="total_value_of_sub_previous" id="total_value_of_sub_previous">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                ...
                success :   function(response)
                {
                    ...
                    size_data  =  "<select name='size[]' onchange='updateStockOnSizeChange(this)' class='form-control combine size_no' style='width:70px;' tabIndex='-1'>";
                                      ...
                                      if(x)
                                      {
                                        ...
                                        //         if('size_'+i ===  key)
                                        //         {
                                        //             console.log(purchaseinvoice[index].size);
