  ...
  <div class="ch-container">
    <div class="row">
      ...
      <div id="content" class="col-lg-10 col-sm-10">
        ...
        <form  action="{{url('update-sale-return-invoice/'.$purchaseinvoicei->id)}}" method="post" enctype="multipart/form-data" id="purchase_form">
         @csrf
         <!-- <span class="formdata"> -->
          <div class="row">
            <div class="box col-md-12">
              <div class="box-inner">
                <div class="box-header well col-sm-10" data-original-title="" style="background-color : rgba(10,10,40,0.7) !important; color:white;">
                  <h2><i class="glyphicon glyphicon-plus"></i>Edit Sale Return Invoice</h2>
                </div>
                <div class="box-content col-sm-10" id="add_form">
                  <div class="row">
                    <div class="form-group col-md-4">
                      <input type="text" hidden="" id="customer_ids" name="customer_id" value="{{$purchaseinvoicei->customer_id}}">
                      ...
                      <div class="controls">
                        <select id="company_id"  data-rel="chosen"
                          ...
                          <option value="{{$customer->name}}" {{$customer->id == $purchaseinvoicei->customer_id  ? 'selected' : ''}}>{{$customer->name}}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                          ...
                          <tr id="TRow" class="d-none">
                            ...
                            <td>
                              {{-- <input style="
                                ...
                                name="product_name[]" onChange="fetchProduct(this)" value="{{$purchaseinvoice->product_name}}"/> --}}
                                <select name="product_name[]" onchange="productName(this)" data-id="{{$purchaseinvoice->id}}" data-key="{{$key=null}}" data-product-id="{{$purchaseinvoice->product_id}}" data-invoice-id="{{$purchaseinvoice->id}}" class="form-control combine js-example-basic-single" id="product_size_no" style="width:70px" tabIndex="-1" required>
                            ...
                            <td style="padding-right: 3px">
                                <input class="form-control combine num_only_integer_quantity vertical stock_no" id="stock-no" value="{{$purchaseinvoice->stock}}"
                                      type="text"  name="stock[]" readonly onkeyup="calc(this)" required  style="width:70px;"/>
                                </td>
                            <input type="hidden" id='pro_id'>
                            <td style="padding-right: 3px">
                            <input class="form-control combine price num_only_integer_quantity vertical price_value"
                                  type="text" readonly name="price[]" required value="{{$purchaseinvoice->price}}" onkeyup="calc(this)"  style="width:70px;"/>
                            </td>
                            <td>
                              <input class="form-control combine num_only_integer_quantity quantity vertical"
                                  type="text"  name="quantity[]" value="{{$purchaseinvoice->quantity}}" required  onkeyup="calc(this)" style="width:70px;"/>
                            </td>
                            <!-- <td >
                            ...
                            <td>
                              <input type="text" readonly class="form-control total total_roww"  name="total[]" required  value="{{$purchaseinvoice->total}}" style="width:70px;">

                         </td>
                            <td>
                              <input type="text"  class="form-control form_discount num_only_decimal vertical" required name="discount_product[]" value="{{$purchaseinvoice->discount}}" onkeyup="calc(this)" style="width:70px;"/>
                            </td>
                            <td>
                              <input type="text" readonly  class="form-control less  num_only_decimal vertical" required name="less[]" value="{{$purchaseinvoice->less}}"  style="width:70px;"/>
                            </td>
                            <td>
                        ...
                        <tfoot id="tfoot">
                          <tr>
                            ...
                            <td colspan="2"  id="total_amount">
                              <input type="text" readonly class="form-control total_value" name="total_value" value="{{$purchaseinvoicei->net}}">
                               <input type="hidden" readonly  class="form-control sum_totals_of_product" name="sum_of_all_product" value="{{$purchaseinvoicei->sum_of_all_product}}">
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td colspan="2" class="discount-td">
                              <input readonly class="form-control discount-val num_only_decimal vertical"
                                ...
                                font-size: 16px;"
                               id="total_discount"
                                type="text"  name="total_discount" value="{{$purchaseinvoicei->discount}}"/>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td colspan="2"  id="net_amount">
                              <input type="text" readonly class="form-control" value="{{$purchaseinvoicei->total_discount_value}}" name="total_discount_value" id="total_discount_value">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="discount-td">
                              ...
                              <input type="text" value="{{$purchaseinvoicei->less}}" class="form-control extra-discountss" name="extra_discount" onkeyup="findExtraDiscount(this)">
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td colspan="2" class="total-val" id="sub_total">
                             <input type="text" readonly name="sub_total" class="form-control sub_totals"  value="{{$purchaseinvoicei->sub_total}}">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="prebal-val" id="previous_bal">
                             <input type="text" readonly value="{{$purchaseinvoicei->old_balance}}" class="form-control balance" id="previous_balance">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="total-val" id="payable_balance">
                              <input type="text" readonly class="form-control" value="{{$purchaseinvoicei->total_value_of_sub_previous}}" name="total_value_of_sub_previous" id="total_value_of_sub_previous">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="discount-td">
                             <input type="text" value="{{$purchaseinvoicei->paid_customer_balance   ?   $purchaseinvoicei->paid_customer_balance    :   '0.00'}}" class="form-control paid_customer_balance" id="paid_customer_balance" name="paid_customer_balance" onkeyup="paidCustomerBalance(this)">
                            </td>
                          </tr>
                          <tr hidden="">
                            <td colspan="6"></td>
                            <td colspan="3" class="form-control discount" style="padding-top: 8px">
                              Paid:
                            </td>
                            <td colspan="2" class="discount-td">
                             <input type="text" value="{{$purchaseinvoicei->paid_customer_balance}}" class=" paid_customer_balance" id="paid_customer_balance" name="paid_customer_balance" onkeyup="paidCustomerBalance(this)">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <input type="text" readonly value="{{$purchaseinvoicei->net_customer_balance}}" class="form-control net_customer_balance" name="net_customer_balance">
                            </td>
                          </tr>
                        </tfoot>
                      </table>
...
function addbtn() {
    var lastRow = $('.product-table tbody tr:last-child');
    ...
    // Remove additional select2 container elements
    newRow.find('.select2-container').remove();

    // Update IDs of form elements inside the cloned row
    newRow.find("[id]").each(function() {
        var oldId = $(this).attr("id");
        var newId = oldId ? oldId.replace(/\d+$/, "") + "_" + ($('.product-table tbody tr').length) : undefined;
    ...
    // Initialize select2 for the entire table
    $('.js-example-basic-single').select2();
}
//      function addbtn()
//   {
