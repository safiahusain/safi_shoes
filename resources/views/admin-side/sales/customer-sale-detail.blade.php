                ...
                <tfoot id="tfoot">
                  ...
                  <tr>
                    <td style="display: flex; gap: 10px;">
                     <a class="a-href" href="{{url('edit-sale-invoice',$purchaseinvoicei->id)}}"> <button type="button" id="btn_aedit" class="btn btn-success btn-sm">Edit</button></a>
                     <a class="a-href" href="{{url('show-sale-invoice')}}"><button type="button" id="btn_close" class="btn btn-success btn-sm">Close</button> </a> 
