                ...
                <!-- ********************product id************************************* -->
                            ...
                            <td>
                              {{-- <input style="
                                ...
                                <select name="product_name[]" class="form-control combine js-example-basic-single"  onchange="productName(this)" id='product_size_no' style="width:70px;" tabIndex="-1" required>
                            ...
                            <input class="form-control combine price num_only_integer_quantity vertical"
                                  type="text" readonly tabIndex="-1"  name="price[]" value="" onkeyup="calc(this)"  required style="width:70px;"/>
                            </td>
                            <td>
                        ...
                        <tfoot id="tfoot">
                          ...
                          <tr>
                            ...
                            <td colspan="2" class="prebal-val" id="previous_bal">
                             <input type="text" value="0.00" readonly tabIndex="-1" class="form-control balance" id="previous_balance" style="width:150px;">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
...
<!-- select2 tag cdn  -->
  ...
  <script>
        ...
        //     $('.invoice-table tbody tr:last-child .size-no-data').html('');
            
        //     console.log(findRow,$(findRow).find("input").val(''),$(findRow).find("select").val(''),$(findRow).removeClass("d-none"));
        //     findRow.find('.js-example-basic-single').select2();
        // }
