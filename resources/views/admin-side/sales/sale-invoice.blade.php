                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title-desc">Data table with CSV and 
                                     ...
                                     <a href="{{url('sale-invoice-form')}}">  <button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light" >
                                            Add New Record
                                        </button> </a> <br><br>
                                    </div> 
                                    ...
                                    <table id="table_one" class="table table-bordered table-responsive nowrap">
                                        ...
                                        <tr>
                                          ...
                                          <td style='width:20%'>
                                                <a href="{{url('edit-sale-invoice/'.$item->id)}}" class=""> <i class="fa-solid fa-pen-to-square"></i></a>
                                                |
                                                <a href="{{ url('delete-sale-invoice/'.$item->id) }}" class="" onclick="return confirm('Are you sure to Delete this Record ?')"><button style="background-color:white; border:none;"><i class="fa-solid fa-trash-can"></button></i></a>
                                                ...
                                                <!-- <button
                                                    ...
                                                    >
                                                 <a href="{{url('customer-sale-detail/'.$item->id)}}">   <i class="fa-solid fa-magnifying-glass-plus"></i></a>
                                                    </button> -->
                                                    |
                                                     <button
                                                    type="button"
                                                    ...
                                                    style="border: none; background-color: transparent; outline: none;" value="{{$item->id}}" id="sale_detail" 
                                                    >
                                                    <i class="fa-solid fa-magnifying-glass-plus"  ></i>
                                                    </button>
                                                    <!--<button  style="background-color:white; border:none;" value="{{$item->id}}" id="sale_details" onclick="getPrint2('exampleModal')"><i class="fa-solid fa-print"></i></button>-->
