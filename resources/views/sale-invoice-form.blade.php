  ...
  <div class="ch-container">
    <div class="row">
      ...
      <div id="content" class="col-lg-10 col-sm-10">
        ...
        <form  action="{{url('store-sale-invoice')}}" method="post" enctype="multipart/form-data" id="purchase_form">
         @csrf
         <!-- <span class="formdata"> -->
          <div class="row">
            <div class="box col-md-12">
              <div class="box-inner">
                <div class="box-header container well col-md-10" data-original-title="" style="background-color : rgba(10,10,40,0.7) !important; color:white;">
                  <h2><i class="glyphicon glyphicon-plus"></i>Add Sale Invoice</h2>
                </div>
                <div class="box-content container  col-md-10" id="add_form">
                  <div class="row">
                    <div class="form-group col-md-4">
                      <input type="text" hidden="" id="customer_id" name="customer_id">
                      <label class="control-label" for="Compnay Name">Customer</label>
                      <div class="controls">
                        <select id="customer_id"  data-rel="chosen"
                ...
                <!-- ********************product id************************************* -->
                            ...
                            <td>
                              <input class="form-control combine num_only_integer_quantity quantity vertical"
                                  type="text"  name="quantity[]" value=""  onkeyup="calc(this)" style="width:50px;" required/>
                            </td>
                            <!-- <td >
                            ...
                            <td>
                              <input type="text" class="form-control total" readonly  name="total[]"  value="0.00" style="width:70px;">
                            ...
                            <td>
                              <input type="text" readonly  class="form-control less  num_only_decimal vertical" name="less[]" value=""  style="width:70px;"/>
                            </td>
                            <td>

                            <input class="form-control net num_only_decimal vertical"
                                  type="text" id="net" readonly  name="net[]" value=""   style="width:70px;"/>
                            </td>
                            <td>
                        ...
                        <tfoot id="tfoot">
                          <tr>
                            ...
                            <td colspan="2"  id="total_amount">
                              <input type="text" class="form-control total_value" readonly name="total_value" style="width:150px;">
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td colspan="2" class="discount-td">
                              ...
                              value="0.00" id="total_discount"
                                type="text" name="total_discount" readonly style="width:150px;"/>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td colspan="2"  id="net_amount">
                              <input type="text" readonly class="form-control" value="00.0" name="total_discount_value" id="total_discount_value" style="width:150px;">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                          ...
                          <tr>
                            ...
                            <td colspan="2" class="total-val" id="sub_total">
                             <input type="text" name=" sub_total" readonly class="form-control sub_totals" value="0.00" style="width:150px;">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="prebal-val" id="previous_bal">
                             <input type="text" value="0.00" readonly class="form-control balance" id="previous_balance" style="width:150px;">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="total-val" id="payable_balance">
                              <input type="text" class="form-control" value="0.00" readonly name="total_value_of_sub_previous" id="total_value_of_sub_previous" style="width:150px;">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                          ...
                          <tr>
                            ...
                            <input type="text" value="0.00" readonly class="form-control net_customer_balance" name="net_customer_balance" style="width:150px;">
                            </td>
                          </tr>
                        </tfoot>
                      </table>
      ...
      function productName(findindex)
      {
        ...
        $.ajax({
           ...
           $(document).on('click', 'li', function(){
            ...
            var value = $(this).text();
console.log('REFRESNSE IS',$(this).closest('tr').find('.product_name'));
      ...
      console.log(response.product);
             ...
             $('.stock_no').eq(index).html('');
              ...
              if(category_table1 == 1)
                        $('.stock_no').eq(index).append(
                        '<option value="'+item.stock_38+'">'+item.stock_38+'</option>',
                        '<option value="'+item.stock_39+'">'+item.stock_39+'</option>',
                        '<option value="'+item.stock_40+'">'+item.stock_40+'</option>',
                        '<option value="'+item.stock_41+'">'+item.stock_41+'</option>',
                        '<option value="'+item.stock_42+'">'+item.stock_42+'</option>',
                        '<option value="'+item.stock_43+'">'+item.stock_43+'</option>',
                        '<option value="'+item.stock_44+'">'+item.stock_44+'</option>',
                        '<option value="'+item.stock_45+'">'+item.stock_45+'</option>',
                        '<option value="'+item.stock_46+'">'+item.stock_46+'</option>',
                    );

                   else if(category_table1 == 2)

                        $('.stock_no').eq(index).append(
                        '<option value="'+item.l_stock_36+'">'+item.l_stock_36+'</option>',
                        '<option value="'+item.l_stock_37+'">'+item.l_stock_37+'</option>',
                        '<option value="'+item.l_stock_38+'">'+item.l_stock_38+'</option>',
                        '<option value="'+item.l_stock_39+'">'+item.l_stock_39+'</option>',
                        '<option value="'+item.l_stock_40+'">'+item.l_stock_40+'</option>',
                        '<option value="'+item.l_stock_41+'">'+item.l_stock_41+'</option>',
                        '<option value="'+item.l_stock_42+'">'+item.l_stock_42+'</option>',
                        ...
                        '<option value="'+item.k_stock_1+'">'+item.k_stock_1+'</option>',
                        '<option value="'+item.k_stock_2+'">'+item.k_stock_2+'</option>',
                        '<option value="'+item.k_stock_3+'">'+item.k_stock_3+'</option>',
                        '<option value="'+item.k_stock_4+'">'+item.k_stock_4+'</option>',
                        '<option value="'+item.k_stock_5+'">'+item.k_stock_5+'</option>',
                        '<option value="'+item.k_stock_6+'">'+item.k_stock_6+'</option>',
                        '<option value="'+item.k_stock_7+'">'+item.k_stock_7+'</option>',
                        '<option value="'+item.k_stock_8+'">'+item.k_stock_8+'</option>',
                        '<option value="'+item.k_stock_9+'">'+item.k_stock_9+'</option>',
                        '<option value="'+item.k_stock_10+'">'+item.k_stock_10+'</option>',
                        '<option value="'+item.k_stock_11+'">'+item.k_stock_11+'</option>',
                        '<option value="'+item.k_stock_12+'">'+item.k_stock_12+'</option>',
                        '<option value="'+item.k_stock_13+'">'+item.k_stock_13+'</option>',
                        '<option value="'+item.k_stock_17+'">'+item.k_stock_17+'</option>',
                        '<option value="'+item.k_stock_18+'">'+item.k_stock_18+'</option>',
                        '<option value="'+item.k_stock_19+'">'+item.k_stock_19+'</option>',
                        '<option value="'+item.k_stock_20+'">'+item.k_stock_20+'</option>',
                        '<option value="'+item.k_stock_21+'">'+item.k_stock_21+'</option>',
                        '<option value="'+item.k_stock_22+'">'+item.k_stock_22+'</option>',
                        '<option value="'+item.k_stock_23+'">'+item.k_stock_23+'</option>',
                        '<option value="'+item.k_stock_24+'">'+item.k_stock_24+'</option>',
                        '<option value="'+item.k_stock_25+'">'+item.k_stock_25+'</option>',
                        '<option value="'+item.k_stock_26+'">'+item.k_stock_26+'</option>',
                        '<option value="'+item.k_stock_27+'">'+item.k_stock_27+'</option>',
                        '<option value="'+item.k_stock_28+'">'+item.k_stock_28+'</option>',
                        '<option value="'+item.k_stock_29+'">'+item.k_stock_29+'</option>',
                        '<option value="'+item.k_stock_30+'">'+item.k_stock_30+'</option>',
                        '<option value="'+item.k_stock_31+'">'+item.k_stock_31+'</option>',
                        '<option value="'+item.k_stock_32+'">'+item.k_stock_32+'</option>',
                        '<option value="'+item.k_stock_33+'">'+item.k_stock_33+'</option>',
                        '<option value="'+item.k_stock_34+'">'+item.k_stock_34+'</option>',
                        '<option value="'+item.k_stock_35+'">'+item.k_stock_35+'</option>',
