                ...
                <!-- ********************product id************************************* -->
                            ...
                            <td>
                              <input class="form-control combine color num_only_integer_quantity vertical " 
                                  type="text"  name="color[]" value=""  style="width:70px;" />
                            </td>
                            <td>
                            ...
                            <input class="form-control combine price num_only_integer_quantity vertical" 
                                  type="text"  name="price[]" value="" onkeyup="calc(this)"  style="width:70px;"/>
                            </td>
                            <td>
                            ...
                            <td>
                              <input type="text" class="form-control total"  name="total[]"  value="0.00" style="width:70px;">
                            ...
                            <td>
                              <input type="text"  class=" form-control less  num_only_decimal vertical" name="less[]" value=""  style="width:70px;"/>
                            </td>
                            <td>

                            <input class="form-control net num_only_decimal vertical" 
                                  type="text" id="net"  name="net[]" value=""   style="width:70px;"/>
                            </td>
                            <td>
                        ...
                        <tfoot id="tfoot" >
                          <tr >
                            ...
                            <td colspan="2"  id="total_amount">
                              <input type="text" class="form-control total_value" name="total_value" readonly style="width:150px;">
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td colspan="2"  id="net_amount">
                              <input type="text" class="form-control" value="00.0" name="total_discount_value" id="total_discount_value" readonly style="width:150px;">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                          ...
                          <tr>
                            ...
                            <td colspan="2" class="total-val" id="sub_total">
                             <input type="text" name="sub_total" class="form-control sub_totals" value="0.00" readonly style="width:150px;">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="prebal-val" id="previous_bal">
                             <input type="text" value="0.00" class="form-control balance" id="previous_balance" readonly style="width:150px;">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="6"></td>
                            ...
                            <td colspan="2" class="total-val" id="payable_balance">
                              <input type="text" value="0.00" class="form-control" name="total_value_of_sub_previous" id="total_value_of_sub_previous" readonly style="width:150px;">
                            </td>
                          </tr>
                          <!-- <tr>
                            <td colspan="6"></td>
                           ...
                           <tr hidden="">
                            ...
                            <input  type="text" value="0.00" class="form-control net_customer_balance" name="net_customer_balance" readonly style="width:150px;">
                            </td> 
                          </tr>
                        </tfoot>
                      </table>
  ...
  var extra_discount = $(".extra-discountss").val();
        ...
        function productName(findindex)
      {
        ...
        $.ajax({
              ...
              type:"GET",
              url:"show-product-name-in-li-sale-return",
